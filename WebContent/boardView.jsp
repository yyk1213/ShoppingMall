...
<nav class="nav flex-column">
  <a class="nav-link disabled" href="product.jsp">All</a>
  <a class="nav-link disabled" href="top.jsp">Top</a>
  <a class="nav-link disabled" href="bottom.jsp">Bottom</a>
  <a class="nav-link disabled" href="boardList.jsp">Board</a>
</nav>
</div>
<%
...
<div class="container col-7" id="content" > 
            <!-- 내용 --> 
             <div > 
                 <h3>자유 게시판</h3> 
                 <p class="show-top1"style="border-bottom : 1px solid; border-top: 2px solid;">subject &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%= title %></p> 
                 <p class="show-top2" style="border-bottom : 1px solid">writer &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%=writer%></p> 
                 <p class="show-top2" style="border-bottom : 1px solid">hit &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%=hit%></p> 
